...
const HospitalMap = props => {
  const {navigation, userInfo, user_lang, userPosition, app_positions, route} =
    props;
  ...
  const getLocation = async () => {
    Geolocation.getCurrentPosition(
      async position => {
        ...
        const appPositionCheck = await app_positions({
  ...
  const snapPoints = useMemo(() => [1, '55%', '94%']);
  ...
  const horizontalCategoryScrollEvent = (category, index, bottoms, catcode) => {
    ...
    let scrollToXvalue =
      user_lang.cidx != 0
        ? (deviceSize.deviceWidth - 40) * 0.3 + 15
        : (deviceSize.deviceWidth - 40) * 0.24 + 15;
  ...
  const onWebViewMessage = webviews => {
    ...
    if (jsonData.data.idx != undefined) {
      navigation.navigate('HospitalInfo', {idx: jsonData.data.idx});
    }
  ...
  //정렬
  const orderlist = [
    {idx: 0, orders: pageText[13]},
    {idx: 1, orders: pageText[14]},
  ];
  ...
  return (
    <GestureHandlerRootView
      ...
      <Box p="20px" pb="20px" position={'absolute'} top={top}>
        <HStack
          ...
          <Box
            ...
            <SearchInput
              ...
              onPressIn={() =>
                navigation.navigate('HospitalSearch', {schText: params.schText})
              }
              iconpink={true}
          ...
          {/* <TouchableOpacity
            ...
            onPress={() =>
              navigation.navigate('LanguageSelect', {back: false})
            }>
            <Image
      ...
      <Box position={'absolute'} top={90 + top + 'px'} left="20px" shadow={4}>
        <Box
          backgroundColor="#fff"
          borderRadius={8}
          ...
          <TouchableOpacity
            style={[
              ...
              pcr == 1 && {backgroundColor: colorSelect.navy},
              user_lang?.cidx != 0 && {width: 74, height: 74},
            ]}
            onPress={pcrChange}>
            <DefText
        ...
        <Box
          ...
          <TouchableOpacity
            style={[
              ...
              fast == 1 && {backgroundColor: colorSelect.pink_de},
              user_lang?.cidx != 0 && {width: 74, height: 74},
            ]}
            onPress={fastChange}>
            <DefText
              text={pageText != '' ? pageText[2] : '약국'}
              style={[
                styles.leftButtonText,
                fast == 1 && {color: colorSelect.white},
              ]}
              lh={user_lang?.cidx == 9 ? 24 : ''}
            />
          </TouchableOpacity>
      ...
      <Box position={'absolute'} top={90 + top + 'px'} right="20px">
        <Box shadow={9} backgroundColor="#fff" borderRadius={48}>
          <TouchableOpacity
            style={[
              styles.leftButton,
              {borderRadius: 48},
        ...
        <Box shadow={5} backgroundColor="#fff" borderRadius={48} mt="15px">
          <TouchableOpacity
            style={[
              styles.leftButton,
              {borderRadius: 48},
              cst == 1 && {backgroundColor: colorSelect.pink_de},
              user_lang?.cidx != 0 && {
                width: 74,
                height: 74,
                ...
                return (
                  <Box
                    ...
                    style={[
                      ...
                      user_lang?.cidx != 0 && {
                        width: (deviceSize.deviceWidth - 40) * 0.3 + 15,
                      },
                    ]}>
                    <Box
                      shadow={5}
                      style={[
                        ...
                        user_lang?.cidx != 0 && {
                          ...
                          height: (deviceSize.deviceWidth - 40) * 0.3,
                        },
                      ]}>
                      <TouchableOpacity
                        style={[
                        ...
                        <DefText
                          ...
                          style={[
                            ...
                            selectCategory == item.category && {color: '#fff'},
                          ]}
                          lh={user_lang?.cidx == 9 ? 24 : ''}
                        />
                      </TouchableOpacity>
      ...
      <BottomSheetModalProvider>
        <BottomSheet
          ...
          <Box py="15px" borderTopWidth={1} borderTopColor="#E3E3E3">
          ...
          <BottomSheetFlatList
            ...
            renderItem={({item, index}) => {
              return (
                <TouchableOpacity
                  ...
                  onPress={() => navigation.navigate('HospitalInfo', item)}>
                  <Box p="20px" pt="10px">
                    ...
                    />
                    <HStack alignItems={'center'} mt="10px" mb="5px">
                      <HStack alignItems={'center'} mr="10px">
                        <Box
                          style={{
                            ...
                            height: 9,
                            borderRadius: 9,
                            backgroundColor: item.consulting
                              ? colorSelect.navy
                              : '#f00',
                            marginRight: 5,
                          }}
                      ...
                      {item.consulting && (
                        <Box>
                          <DefText
                            text={
                              item.today_stime.substring(0, 5) +
                              ' ~ ' +
                              item.today_etime.substring(0, 5)
                            }
            ...
            ListEmptyComponent={
              <Box flex={1} py="60px">
                <EmptyPage
                  emptyText={
                    pageText != '' ? pageText[12] : '병원목록이 없습니다.'
                  }
                />
              </Box>
            }
                      ...
                      <TouchableOpacity
                        ...
                        <Box
                          style={[
                            ...
                            (index + 1) % 3 != 0 && {
                              marginRight:
                                (deviceSize.deviceWidth - 40) * 0.034,
                            },
                          ]}
                          shadow={5}>
                          <Image
