  ...
  const pageApi = async () => {
    ...
    await Api.send(
      'hospital_list',
      {
        ...
        orderby: 1,
        catcode: params?.selectCate.catcode,
        pcr: 0,
        fast: 0,
        cst: 0,
        rsv: 0,
  ...
  return (
    <Box flex={1} backgroundColor={'#fff'} pt={top + 'px'}>
      <HStack
        ...
        <Box width={(deviceSize.deviceWidth - 40) * 0.87}>
          <SearchInput
      ...
      <HStack
        ...
        <HStack>
          ...
          >
            <DefText text={'거리순'} style={[styles.bottomSheetButtonText]} />
          </TouchableOpacity>
          <TouchableOpacity
            style={[styles.bottomSheetButton, {borderColor: colorSelect.navy}]}
        ...
        <HStack>
          <TouchableOpacity
            ...
            <DefText text={'병원'} style={[styles.bottomSheetButtonText]} />
          </TouchableOpacity>
          <TouchableOpacity
            style={[
              styles.bottomSheetButton,
            ...
            <DefText text={'약국'} style={[styles.bottomSheetButtonText]} />
          </TouchableOpacity>
        </HStack>
      </HStack>
      <BoxLine />
