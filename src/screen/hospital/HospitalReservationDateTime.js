...
//병원 예약 시간 선택
const HospitalReservationDateTime = (props) => {
    ...
    //달력표시
    const calendarsAPI = () => {
        Api.send('hospital_reservation01', {'hidx':params.hidx, "date":nowMonth}, (args)=>{

            let resultItem = args.resultItem;
            let arrItems = args.arrItems;
    
            if(resultItem.result === 'Y' && arrItems) {
              // console.log('병원 달력 상테 정보: ', resultItem, arrItems.date);
            ...
            //    console.log(Object.values(arrItems.date));
               ...
               console.log('병원 달력 상테 실패!', resultItem);
                ...
                <Modal.Content width={deviceSize.deviceWidth - 40} p='20px'>
                    <Modal.Body p='0'>
                        ...
                        <Box>
                            ...
                            />
                            <DefText 
                                text={ pageText != "" ? pageText[17] : "예약가능시간 : 14시 이후 ~"}
                                style={[
                                    styles.modalText,
                                    fweight.bold,
                                    {marginTop:5}
